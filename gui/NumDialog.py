...
class NumDialog(object):
    def setupUi(self, Dialog):
        ...
        self.newColumnCheckbox = QtWidgets.QCheckBox("Add in new column?", Dialog)
        self.newColumnCheckbox.setFont(font)
        self.newColumnCheckbox.setGeometry(QtCore.QRect(40, 200, 200, 50))
        font = QtGui.QFont()
        font.setPointSize(13)
